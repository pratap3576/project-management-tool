...
class Email_templates extends MY_Controller {
    ...
    private function _templates() {
        ...
        if ($tickets_template_variables) {
            ...
            $templates_array["ticket_created"] = array_merge($templates_array["ticket_created"], $tickets_template_variables);
            $templates_array["ticket_commented"] = array_merge($templates_array["ticket_commented"], $tickets_template_variables);
            $templates_array["ticket_closed"] = array_merge($templates_array["ticket_closed"], $tickets_template_variables);
            $templates_array["ticket_reopened"] = array_merge($templates_array["ticket_reopened"], $tickets_template_variables);
        }
